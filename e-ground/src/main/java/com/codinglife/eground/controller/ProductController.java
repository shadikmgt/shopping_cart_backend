package com.codinglife.eground.controller;
...
import com.codinglife.eground.response.ApiResponse;
import com.codinglife.eground.service.product.IProductService;
...
public ResponseEntity<ApiResponse>getProductByCategoryAndBrand(@RequestParam String category, String brand){
    try {
        List<Product> products = productService.getProductsCategoryAndBrand(category, brand);
        if (products.isEmpty()){
